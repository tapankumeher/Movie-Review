...
namespace Movie_Review
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var connectionString = Configuration["ConnectionStrings:MovieConnectionString"];
            services.AddDbContext<MovieDbContext>(c => c.UseSqlServer(connectionString));
            services.AddSwaggerGen(c => c.SwaggerDoc("v1", new Microsoft.OpenApi.Models.OpenApiInfo { Title = "Movies Rest API", Version = "v1" }));
        }
